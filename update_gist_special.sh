...
FILENAME="filtered_domains_special_mikrotik.txt"  # Name of the file in the Gist
LOCAL_FILE_PATH="/path/to/your/local/filtered_domains_special_mikrotik.txt"  # Path to the local file
